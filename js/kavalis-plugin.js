(function ($) {
    ...
    var tipsOverlayHTML, medicalTermsButton, medicalTermsOverlay, medicalTermsArray,
        medicalTermsModalStart, medicalTermsModalEnd, medicalTermsModalContent;


    tipsOverlayHTML = '<div id="instructions-wrapper">'
                            + '<div id="quickTipsCloseX">+</div>'
                            + '<div class="instruction-1-container">'
                            + '<img src="/wp-content/plugins/kavalis-plugin/img/white-arrow-left.png">'
                            ...
                            + '</div>'
                              + '<div class="instruction-2-container">'
                                + '<div class="instructions-2-text-wrapper">'
                                  + '<img src="/wp-content/plugins/kavalis-plugin/img/white-arrow-right.png">'
    ...
    medicalTermsButton = '<button class="medical-terms-button">Medical Terms</button>';

    medicalTermsOverlay = '<div id="kv_medical_tips_overlay"></div>';
    ...
    medicalTermsModalStart =  '<div class="kv_modal">'
    ...
    medicalTermsModalEnd = '</div></div></div></div></div>';
    ...
    function kv_start() {
        ...
        function prepareTermsDialog(termsType) {
            ...
            for (i = 0; i < termsArray.length; i += 1) {
                termsBody += ' <div class="kv-term-row"><div><div class="kv-term-value">' + termsArray[i].term + '</div></div><div><div class="kv-term-abbreviation">' + termsArray[i].abbreviation + '</div></div></div>';
            }
